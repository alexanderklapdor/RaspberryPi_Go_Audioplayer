...
Audio abspielen &  \\ \hline
Audio pausieren &  \\ \hline
Audio fortfahren &  \\ \hline
Audio stoppen &  \\ \hline
Weiter &  \\ \hline
Zurück &  \\ \hline
Audio zur Playlist hinzufügen &  \\ \hline
Audio von Playlist löschen &  \\ \hline
Lautstärke festlegen &  \\ \hline
Lautstärke erhöhen &  \\ \hline
Lautstärke verringern &  \\ \hline
Shuffel-Funktion aktivieren/deaktivieren &  \\ \hline
Loop-Funktion aktivieren/deaktivieren &  \\ \hline
aktuellen Song neustarten &  \\ \hline
Informationen ausgeben & 
\end{tabular}
\caption{Funktionen des Audioplayers}
\label{tab:funktions_tabelle}
\end{table}

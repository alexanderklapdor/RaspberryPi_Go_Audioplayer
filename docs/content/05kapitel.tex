...
\begin{description}
\item[Herunterladen der neusten \href{https://github.com/alexanderklapdor/RaspberryPi_Go_Audioplayer/releases}{Release} Datei] \hfill \\ 
\begin{lstlisting}
wget [LINK]
\end{lstlisting}
\item[Entpacken des Archiv] \hfill \\
\begin{lstlisting}
tar -xvf RaspberryPi_Go_Audioplayer_v***.tar
\end{lstlisting}
\item[Starten des Audioplayers] \hfill \\
\begin{lstlisting}

...
durchlaufen. Dieser Enticklungsverlauf wird allgemein auch als \acs{SDLC} bezeichnet
...
und erste Analysen zur Umsetzung vollzogen. Die Anforderungsanalyse wurde
bereits im ersten Kapitel der Arbeit erörtert, als der Ist- und Soll-Zustand
benannt und die damit vorliegende Problemstellung dargelegt wurden. \newline
In diesem Kapitel soll nun auf die verschiedenen Möglichkeiten bei der
Umsetzung eingegangen werden. Darunter fällt vorallem der Vergleich
verschiedener Technologien und Bibliotheken, welche später bei der Implementierung eingesetzt werden
könnten.

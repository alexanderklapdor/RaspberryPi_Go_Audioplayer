...
\lstinputlisting[language=Golang,nolol]{../src/MusicPlayerClient.go}

\pagebreak

\section*{B. Quellcode - MusicPlayerServer.go}
\lstinputlisting[language=Golang,nolol]{../src/MusicPlayerServer.go}

\pagebreak

\section*{C. Quellcode - logger/logger.go}
\lstinputlisting[language=Golang,nolol]{../src/logger/logger.go}

\pagebreak

\section*{D. Quellcode - portaudiofunctions/portaudiofunctions.go}
\lstinputlisting[language=Golang,nolol]{../src/portaudiofunctions/portaudiofunctions.go}

\pagebreak

\section*{E. Quellcode - screener/screener.go}
\lstinputlisting[language=Golang,nolol]{../src/screener/screener.go}

\pagebreak

\section*{F. Quellcode - sender/sender.go}
\lstinputlisting[language=Golang,nolol]{../src/sender/sender.go}

\pagebreak

\section*{G. Quellcode - serverfunctions/audiofunctions/audiofunctions.go}
\lstinputlisting[language=Golang,nolol]{../src/serverfunctions/audiofunctions/audiofunctions.go}

\pagebreak

\section*{H. Quellcode - serverfunctions/connectionfunctions/connectionfunctions.go}
\lstinputlisting[language=Golang,nolol]{../src/serverfunctions/connectionfunctions/connectionfunctions.go}

\pagebreak

\section*{I. Quellcode - serverfunctions/volumefunctions/volumefunctions.g}
\lstinputlisting[language=Golang,nolol]{../src/serverfunctions/volumefunctions/volumefunctions.go}

\pagebreak

\section*{J. Quellcode - structs/structs.go}
\lstinputlisting[language=Golang,nolol]{../src/structs/structs.go}

\pagebreak

\section*{K. Quellcode - util/util.go}
\lstinputlisting[language=Golang,nolol]{../src/util/util.go}
